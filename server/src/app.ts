...
app.use(
  cors({
    origin: ['https://thebotstreet.netlify.app','http://localhost:5173','http://localhost:5174', 'https://botstreet2025-production.up.railway.app/','https://essaylogger.netlify.app'], // Add both development and production URLs
