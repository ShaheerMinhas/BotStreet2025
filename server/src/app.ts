...
app.use(
  cors({
    origin: ['https://thebotstreet.netlify.app','https://essaygenie.netlify.app','http://localhost:5173','http://localhost:5174', 'https://botstreet2025.onrender.com'], // Add both development and production URLs
